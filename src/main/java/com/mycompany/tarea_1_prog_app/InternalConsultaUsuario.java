...
public class InternalConsultaUsuario extends javax.swing.JInternalFrame {
    ...
    Usuario u = control.obtenerUsuarioPorNickname(nicknameSeleccionado);
    ...
    if (u != null) {
        ...
        // Suponiendo que tienes un JDateChooser o TextField para la fecha
        txtFechaNac.setText(u.getFechaNac().toString()); 
    ...
    if (evt.getClickCount() == 2) {
        ...
        if (seleccionado != null) {
            /* 
             * Aca va el caso de uso ConsultaCurso. "InternalConsultaCurso":
             */
            
            // InternalConsultaCurso ventanaCurso = new InternalConsultaCurso(control, seleccionado);
            // this.getDesktopPane().add(ventanaCurso); // Lo agregamos al escritorio principal

            // ventanaCurso.setVisible(true);
            
            // Mensaje temporal para probar que detecta el clic correctamente:
            javax.swing.JOptionPane.showMessageDialog(this, "Debería abrir la consulta para: " + seleccionado);
        }
    }
    ...
    if (evt.getClickCount() == 2) {
        ...
        if (seleccionado != null) {
            /* 
             * Aca va el caso de uso ConsultaPrograma. "InternalConsultaPrograma":
             */
            
            // InternalConsultaPrograma ventanaCurso = new InternalConsultaPrograma(control, seleccionado);
            // this.getDesktopPane().add(ventanaCurso); // Lo agregamos al escritorio principal
